...
#show: mfr.with(
  mytitle: "CAP en 1 an",
  mysubtitle: "Plan d'etude en mathématiques ; version 1"
)

// ─── 1. Objectifs ────────────────────────────────────────
= Objectifs

Le plan vise à renforcer les bases en arithmétique, algèbre, fonctions et géométrie,
